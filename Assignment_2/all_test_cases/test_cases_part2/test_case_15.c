...
int main (u64 arg1, u64 arg2, u64 arg3, u64 arg4, u64 arg5) {
    ...
    // Read 2196 characters from the ppipe.
    char read_buffer_2[2197];
    read_buffer_2[2196] = 'p';
    ret_code = read (fd[0], read_buffer_2, 2196);
    if (ret_code < 0) {
        ...
        // Expected result should be 2196 and the last character in the read
        // buffer should be 'v' and next should be 'p';
        printf ("%d\n", ret_code);
        printf ("%c\n", read_buffer_2[2195]);
        printf ("%c\n", read_buffer_2[2196]);
    ...
    // Call flush which will return 2196.
    ret_code = flush_ppipe (fd);
    if (ret_code < 0) {
