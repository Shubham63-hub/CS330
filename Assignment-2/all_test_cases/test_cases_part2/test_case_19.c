...
int main (u64 arg1, u64 arg2, u64 arg3, u64 arg4, u64 arg5) {
    ...
    /**
     *  Call ppipe upto the (maximum possible fds)/ 2 which is MAX_OPEN_FILES/ 2
	...
	if (!pid) {                 // Child 1 code.
        ...
        /**
         *  Call ppipe 2 times in this child.
         */
        ...
        if (ret_code < 0) {
            ...
            printf("Child 1: Persistent Pipe allocation failed!!!\n");
            return -1;
        ...
        if (!pid_2) {           // Child 2 code.
            ...
            /**
             *  Call ppipe 3 times in this child.
             */
            ...
            if (ret_code < 0) {
                ...
                printf("Child 2: Persistent Pipe allocation failed!!!\n");
                return -1;
